...
class MyModel:
    ...
    def __init__(self):
        ...
        self.my_feature_columns.append(tf.feature_column.numeric_column(key=FEATURES[0]))
        self.my_feature_columns.append(tf.feature_column.numeric_column(key=FEATURES[1]))
        self.my_feature_columns.append(tf.feature_column.numeric_column(key=FEATURES[2], shape=[96, 160]))
        self.my_feature_columns.append(tf.feature_column.numeric_column(key=FEATURES[3], shape=[65, 160]))
        self.my_feature_columns.append(tf.feature_column.numeric_column(key=FEATURES[4], shape=[4, 160]))
